        ...
        <tbody>
            @foreach ($berita as $key => $berita)
                <tr>
                    ...
                    <td><button class="btn btn-warning"  data-bs-toggle="modal" data-bs-target="#updateModal" data-url="{{ route('berita.update',['id'=>$berita->kd_berita]) }}" data-nama_berita="{{ $berita->nama_berita }}">Update</button> | <a href="{{ route('berita.delete', ['id'=>$berita->kd_berita]) }}" class="btn btn-danger">Delete</a></td>
